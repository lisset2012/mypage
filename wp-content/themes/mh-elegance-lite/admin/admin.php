		...
		<div class="theme-info-wrap">
			...
			<div class="theme-links clearfix">
				<p>
					...
					<a href="<?php echo esc_url('https://www.mhthemes.com/themes/mh/elegance-lite/'); ?>" target="_blank">
					...
					<a href="<?php echo esc_url('https://wordpress.org/support/theme/mh-elegance-lite'); ?>" target="_blank">
				...
				<div class="row clearfix">
					<div class="col-1-2">
						...
						<div class="section">
							...
							<p>
								<a href="<?php echo esc_url('https://www.mhthemes.com/themes/mh/elegance/'); ?>" target="_blank" class="button button-primary">
